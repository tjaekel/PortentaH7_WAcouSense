...
C_SRCS += \
../VisionShield/audio.c 

C_DEPS += \
./VisionShield/audio.d 

OBJS += \
./VisionShield/audio.o 


# Each subdirectory must supply rules for building sources it contributes
VisionShield/%.o VisionShield/%.su VisionShield/%.cyclo: ../VisionShield/%.c VisionShield/subdir.mk
...
clean: clean-VisionShield

clean-VisionShield:
	-$(RM) ./VisionShield/audio.cyclo ./VisionShield/audio.d ./VisionShield/audio.o ./VisionShield/audio.su

.PHONY: clean-VisionShield
